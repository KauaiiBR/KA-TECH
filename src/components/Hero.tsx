    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        <video
          ...
          loop
          playsInline
          src="/videos/hero-background.mp4" // ← CAMINHO DA PASTA PUBLIC
          className="w-full h-full object-cover opacity-60 scale-102"
          referrerPolicy="no-referrer"
        />
        {/* Overlays */}
        <div className="absolute inset-0 bg-gradient-to-t from-[#0A0A09] via-black/60 to-transparent" />
              ...
              <div className="relative h-full flex flex-col justify-between z-10">
                ...
                <div className="flex items-center justify-between border-t border-neutral-800 pt-3">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-xs text-gray-400 font-medium font-mono">Pirapora e Região</span>
                  </div>
