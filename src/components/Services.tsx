              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center justify-center w-9 h-9 rounded bg-gradient-to-br from-[#252525] to-[#1a1a1a] border border-white/10 text-[#7C3AED] group-hover:bg-[#7C3AED]/10 group-hover:border-[#7C3AED]/50 transition-all duration-300 shadow-md">
                  ...
                  <div className="space-y-1">
                    <h3 className="font-display font-black text-lg sm:text-xl text-white uppercase group-hover:text-[#7C3AED] transition-colors duration-300">
                      {srv.title}
                    </h3>
                  ...
                  {/* Checklist items */}
                  <div className="space-y-1.5 pt-2 border-t border-neutral-700 group-hover:border-[#7C3AED]/20 transition-colors duration-300">
                    {srv.features.map((feature, fIdx) => (
                      <div key={fIdx} className="flex items-start space-x-2 text-xs text-gray-200 font-sans">
                        <CheckSquare size={12} className="text-[#7C3AED] mt-0.5 shrink-0" />
                        <span>{feature}</span>
                      </div>
                    ))}
                  </div>
                ...
                <div className="pt-4 mt-3">
                  <button
                    ...
                    className="inline-flex items-center space-x-2 text-[10px] font-bold font-display uppercase tracking-widest text-white group-hover:text-[#7C3AED] transition-colors duration-300 cursor-pointer"
                  >
